...
class SeenViewModel : ViewModel() {
    ...
    fun getMovieList(): List<MovieItem> {
        return listOf(
            ...
            MovieItem("seen_poster/poster_4.png","기생충",5, "“너는 계획이 다 있구나.”", "2019. 09. 30.", "롯데시네마 대전센트럴"),
            ...
            MovieItem("seen_poster/poster_8.png","Cruella",2, "잔인하다기보단 애달픈 ‘가족’영화.", "2025. 06. 24.", "카이스트 크래프톤 빌딩"),
